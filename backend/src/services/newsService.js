    ...
    try {
      ...
      const mockNews = [
        ...
        },
        {
          ...
          url: "https://example.com/manufacturing-pmi",
        ...
        },
        {
          ...
          url: "https://example.com/trade-supply-chains",
        ...
        },
        {
          ...
          url: "https://example.com/labor-market",
    ...
    try {
      ...
      const mockSPYNews = [
        ...
        },
        {
          ...
          url: "https://example.com/spy-sector-rotation",
          publishedAt: new Date(Date.now() - 7 * 60 * 60 * 1000), // 7 hours ago
        ...
        },
        {
          ...
          url: "https://example.com/spy-liquidity",
          publishedAt: new Date(Date.now() - 8 * 60 * 60 * 1000), // 8 hours ago
        ...
        },
        {
          ...
          url: "https://example.com/spy-vix-correlation",
          publishedAt: new Date(Date.now() - 9 * 60 * 60 * 1000), // 9 hours ago
        ...
        },
        {
          ...
          url: "https://example.com/spy-international",
          publishedAt: new Date(Date.now() - 11 * 60 * 60 * 1000), // 11 hours ago
        ...
        },
        {
          ...
          url: "https://example.com/spy-concentration",
          publishedAt: new Date(Date.now() - 12 * 60 * 60 * 1000), // 12 hours ago
